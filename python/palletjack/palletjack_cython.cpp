...
static PyObject *__pyx_pf_10palletjack_17palletjack_cython_2read_metadata(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_index_file_path, PyObject *__pyx_v_row_groups, PyObject *__pyx_v_column_indices, PyObject *__pyx_v_column_names); /* proto */
...
static PyObject *__pyx_f_10palletjack_17palletjack_cython_read_metadata(PyObject *__pyx_v_index_file_path, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_10palletjack_17palletjack_cython_read_metadata *__pyx_optional_args) {
  ...
  PyObject *__pyx_v_column_indices = __pyx_k__3;
  PyObject *__pyx_v_column_names = __pyx_k__4;
 ...
 */
  ...
  __pyx_t_5 = __pyx_convert_string_from_py_6libcpp_6string_std__in_string(__pyx_t_1); if (unlikely(PyErr_Occurred())) __PYX_ERR(4, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __pyx_v_ccolumn_indices = __PYX_STD_MOVE_IF_SUPPORTED(__pyx_t_6);
 ...
 *     return m
 */
  __pyx_t_1 = __Pyx_tp_new(((PyObject *)__pyx_ptype_7pyarrow_8_parquet_FileMetaData), __pyx_empty_tuple); if (unlikely(!__pyx_t_1)) __PYX_ERR(4, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (!(likely(__Pyx_TypeTest(__pyx_t_1, __pyx_ptype_7pyarrow_8_parquet_FileMetaData)))) __PYX_ERR(4, 25, __pyx_L1_error)
 ...
 *     return m
 */
  __pyx_t_1 = __pyx_f_7pyarrow_8_parquet_12FileMetaData_init(__pyx_v_m, __pyx_v_c_metadata); if (unlikely(!__pyx_t_1)) __PYX_ERR(4, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
...
PyDoc_STRVAR(__pyx_doc_10palletjack_17palletjack_cython_2read_metadata, "read_metadata(index_file_path, row_groups=[], column_indices=[], column_names=[])");
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    PyObject **__pyx_pyargnames[] = {&__pyx_n_s_index_file_path,&__pyx_n_s_row_groups,&__pyx_n_s_column_indices,&__pyx_n_s_column_names,0};
    values[1] = __Pyx_Arg_NewRef_FASTCALL(__pyx_k__2);
    values[2] = __Pyx_Arg_NewRef_FASTCALL(__pyx_k__3);
    values[3] = __Pyx_Arg_NewRef_FASTCALL(__pyx_k__4);
    if (__pyx_kwds) {
      Py_ssize_t kw_args;
      switch (__pyx_nargs) {
  ...
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("read_metadata", 0, 1, 4, __pyx_nargs); __PYX_ERR(4, 15, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  {
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10palletjack_17palletjack_cython_2read_metadata(__pyx_self, __pyx_v_index_file_path, __pyx_v_row_groups, __pyx_v_column_indices, __pyx_v_column_names);
...
static PyObject *__pyx_pf_10palletjack_17palletjack_cython_2read_metadata(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_index_file_path, PyObject *__pyx_v_row_groups, PyObject *__pyx_v_column_indices, PyObject *__pyx_v_column_names) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  __pyx_tuple__6 = PyTuple_Pack(2, __pyx_n_s_pyarrow, __pyx_n_s_parquet); if (unlikely(!__pyx_tuple__6)) __PYX_ERR(4, 4, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__7 = PyTuple_Pack(2, __pyx_n_s_parquet_path, __pyx_n_s_index_file_path); if (unlikely(!__pyx_tuple__7)) __PYX_ERR(4, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(2, 0, 0, 2, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_palletjack_palletjack_cython_pyx, __pyx_n_s_generate_metadata_index, 12, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) __PYX_ERR(4, 12, __pyx_L1_error)
 ...
 *     cdef shared_ptr[CFileMetaData] c_metadata
 */
  __pyx_tuple__9 = PyTuple_Pack(4, __pyx_n_s_index_file_path, __pyx_n_s_row_groups, __pyx_n_s_column_indices, __pyx_n_s_column_names); if (unlikely(!__pyx_tuple__9)) __PYX_ERR(4, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__9);
  __Pyx_GIVEREF(__pyx_tuple__9);
  __pyx_codeobj__10 = (PyObject*)__Pyx_PyCode_New(4, 0, 0, 4, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__9, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_palletjack_palletjack_cython_pyx, __pyx_n_s_read_metadata, 15, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__10)) __PYX_ERR(4, 15, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_7cpython_8datetime_date = __Pyx_ImportType_3_0_9(__pyx_t_1, "datetime", "date", sizeof(PyDateTime_Date), __PYX_GET_STRUCT_ALIGNMENT_3_0_9(PyDateTime_Date),__Pyx_ImportType_CheckSize_Warn_3_0_9); if (!__pyx_ptype_7cpython_8datetime_date) __PYX_ERR(2, 70, __pyx_L1_error)
  __pyx_ptype_7cpython_8datetime_time = __Pyx_ImportType_3_0_9(__pyx_t_1, "datetime", "time", sizeof(PyDateTime_Time), __PYX_GET_STRUCT_ALIGNMENT_3_0_9(PyDateTime_Time),__Pyx_ImportType_CheckSize_Warn_3_0_9); if (!__pyx_ptype_7cpython_8datetime_time) __PYX_ERR(2, 83, __pyx_L1_error)
  __pyx_ptype_7cpython_8datetime_datetime = __Pyx_ImportType_3_0_9(__pyx_t_1, "datetime", "datetime", sizeof(PyDateTime_DateTime), __PYX_GET_STRUCT_ALIGNMENT_3_0_9(PyDateTime_DateTime),__Pyx_ImportType_CheckSize_Warn_3_0_9); if (!__pyx_ptype_7cpython_8datetime_datetime) __PYX_ERR(2, 109, __pyx_L1_error)
  __pyx_ptype_7cpython_8datetime_timedelta = __Pyx_ImportType_3_0_9(__pyx_t_1, "datetime", "timedelta", sizeof(PyDateTime_Delta), __PYX_GET_STRUCT_ALIGNMENT_3_0_9(PyDateTime_Delta),__Pyx_ImportType_CheckSize_Warn_3_0_9); if (!__pyx_ptype_7cpython_8datetime_timedelta) __PYX_ERR(2, 147, __pyx_L1_error)
  __pyx_ptype_7cpython_8datetime_tzinfo = __Pyx_ImportType_3_0_9(__pyx_t_1, "datetime", "tzinfo", sizeof(PyDateTime_TZInfo), __PYX_GET_STRUCT_ALIGNMENT_3_0_9(PyDateTime_TZInfo),__Pyx_ImportType_CheckSize_Warn_3_0_9); if (!__pyx_ptype_7cpython_8datetime_tzinfo) __PYX_ERR(2, 160, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 * from libcpp.string cimport string
 */
  __pyx_t_2 = __Pyx_ImportDottedModule(__pyx_n_s_pyarrow_parquet, __pyx_tuple__6); if (unlikely(!__pyx_t_2)) __PYX_ERR(4, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 * 
 */
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_10palletjack_17palletjack_cython_1generate_metadata_index, 0, __pyx_n_s_generate_metadata_index, NULL, __pyx_n_s_palletjack_palletjack_cython, __pyx_d, ((PyObject *)__pyx_codeobj__8)); if (unlikely(!__pyx_t_2)) __PYX_ERR(4, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = PyList_New(0); if (unlikely(!__pyx_t_4)) __PYX_ERR(4, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = PyTuple_New(3); if (unlikely(!__pyx_t_5)) __PYX_ERR(4, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_GIVEREF(__pyx_t_2);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_5, 0, __pyx_t_2)) __PYX_ERR(4, 15, __pyx_L1_error);
  __Pyx_GIVEREF(__pyx_t_3);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_5, 1, __pyx_t_3)) __PYX_ERR(4, 15, __pyx_L1_error);
  __Pyx_GIVEREF(__pyx_t_4);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_5, 2, __pyx_t_4)) __PYX_ERR(4, 15, __pyx_L1_error);
  __pyx_t_2 = 0;
  __pyx_t_3 = 0;
  __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_CyFunction_New(&__pyx_mdef_10palletjack_17palletjack_cython_3read_metadata, 0, __pyx_n_s_read_metadata, NULL, __pyx_n_s_palletjack_palletjack_cython, __pyx_d, ((PyObject *)__pyx_codeobj__10)); if (unlikely(!__pyx_t_4)) __PYX_ERR(4, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_CyFunction_SetDefaultsTuple(__pyx_t_4, __pyx_t_5);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_read_metadata, __pyx_t_4) < 0) __PYX_ERR(4, 15, __pyx_L1_error)
